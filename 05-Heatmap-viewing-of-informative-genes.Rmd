...
```{r rpc_time, fig.cap = 'Sample trajectory colored by real time points'}
plot_cell_trajectory(human, color_by = "time")
```

```{r rpc_pseudotime, fig.cap = 'Same trajectory colored by Pseudotime'}
...
pheatmap(
  ...
  drop_levels       = TRUE,
  fontsize          = 14,
  main              = "Scaled log-rpc heatmap, POST sample ordered by Pseudotime"
)
```